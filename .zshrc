...
alias allmaster="ls | xargs -P10 -I{} git -C {} pull"

alias kongproxyip='export PROXY_IP=$(kubectl get -o jsonpath="{.status.loadBalancer.ingress[0].ip}" service -n kong kong-proxy)'
